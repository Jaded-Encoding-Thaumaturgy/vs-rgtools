...
removegrain_aka_exprs = list[Callable[[], str] | None]([
    aka_removegrain_expr_1, partial(aka_removegrain_expr_2_4, 2),
    ...
    aka_removegrain_expr_21_22, aka_removegrain_expr_21_22, None, None,
    None, aka_removegrain_expr_26, aka_removegrain_expr_27, aka_removegrain_expr_28
])

repair_aka_exprs = list[Callable[[], str] | None]([
    partial(aka_repair_expr_1_4, 1), partial(aka_repair_expr_1_4, 2),
    ...
    None, aka_repair_expr_26, aka_repair_expr_27, aka_repair_expr_28
])
